...
# # Collect optional KaHIP hints (from env)
# EXTRA_CMAKE=()
# if [[ -n "${KAHIP_NODE_ORDERING:-}" ]]; then
#   EXTRA_CMAKE+=("-DKAHIP_NODE_ORDERING=${KAHIP_NODE_ORDERING}")
# fi
# if [[ -n "${KAHIP_HOME:-}" ]]; then
#   EXTRA_CMAKE+=("-DKAHIP_HOME=${KAHIP_HOME}")
# fi
