...
bool Bi_Directional_Spira::should_expand_forward(
    const priority_queue<pair<Cost, EdgeId>, vector<pair<Cost, EdgeId>>, greater<pair<Cost, EdgeId>>>& pq_forward,
    const priority_queue<pair<Cost, EdgeId>, vector<pair<Cost, EdgeId>>, greater<pair<Cost, EdgeId>>>& pq_backward,
    bool stop_f,
    bool stop_b) const
{
...
Bi_Directional_Dijkstra_Result Bi_Directional_Spira::compute_shortest_path(NodeId src, NodeId dst)
{
    ...
    priority_queue<pair<Cost, EdgeId>, vector<pair<Cost, EdgeId>>, greater<pair<Cost, EdgeId>>> pq_forward;
    priority_queue<pair<Cost, EdgeId>, vector<pair<Cost, EdgeId>>, greater<pair<Cost, EdgeId>>> pq_backward;
